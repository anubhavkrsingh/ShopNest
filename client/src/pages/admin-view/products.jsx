    ...
    <Fragment>
      ...
      onOpenChange={() => {
        ...
        <SheetContent side='right' className="overflow-auto">
          ...
          <div className='py-6'>
            <CommonForm 
            onSubmit = {onSubmit} formData={formData} setFormData={setFormData} buttonText={currentEditedId !== null ? 'Edit' : 'Add'} formControls={addProductFormElements}
